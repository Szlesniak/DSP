...
switch mode_PLL
    case 0  % BEZ PLL
        % Warianty: idealna nośna 38kHz, 38001Hz, przesunięcie fazowe
        f_test = 38e3;          % Można ustawić np. 38001
        phi_test = 0;          % Można ustawić np. pi/4
...
% Wykres kanałów
figure;
plot(yL,'b'); hold on; plot(yR,'r'); legend('Lewy','Prawy'); title('Kanały stereo');
